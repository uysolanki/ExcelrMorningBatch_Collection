...
public class SinglyLinkedList {
	public static void main(String[] args) {
		...
		System.out.println("Enter Position of New Node"); // 3;
		int pos=sc.nextInt();
		
		System.out.println("Enter data for Middle Node"); // Gaurav
		String name=sc.next();
		
		addMid(head,pos,name);
		System.out.println("Display After Adding at Middle position");
		display(head);
	}

	private static void addMid(Node head,int pos,String name) {
		Node temp=head;
		int i=1;
		while(i<pos-1)
		{
